...
func Test_Process_Returns_CorrectDependencies(t *testing.T) {
	...
	process_test.go:156: Response actual =
	&{
		[
			{doctrine/doctrine  2.3.5 [] {   } {   } map[twigphp/twig:2.4.1] map[] map[] map[]}
			{twigphp/twig  2.4.1 [] {   } {   } map[] map[] map[] map[]}
			{symfony/symfony  2.3.5 [] {   } {   } map[twigphp/twig:2.4.1] map[] map[] map[]}] []
		}
			, expected
	&{
		[
